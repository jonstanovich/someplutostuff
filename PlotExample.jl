...
plot(years, apples, legend=false, title="Number of apples per year", color = "red")
...
# ╔═╡ 179fe6be-9371-4449-a123-527b0189a6b3
oranges = rand(1:100, 10)

# ╔═╡ 95300073-01e7-4c8e-80e4-b3ebc0e78fd5
pluots  = rand(2:20, 10)
...
begin
	...
	plot!(years, pluots, label ="pluots")
end
...
# ╔═╡ 0a6efe24-843a-4966-98e9-83c869475104
scatter(oranges, pluots)
...
plot(apples_plot, apples_vs_oranges, layout=(2,1))
...
plot!(pears_plot, years, oranges, label="bananas")
...
function plot_pears()
	myplot = plot(years, pluots, label="pears")
	return myplot
end
