...
# ╔═╡ d1103d98-a825-46dd-b654-994c17ce7d59
using Plots

# ╔═╡ 31117970-c899-4be9-aaa4-03f67063ff86
ENV["GRDIR"]=""

# ╔═╡ 111366a6-c5ae-407d-b0a1-f96ee98157d2
Pkg.build("GR")

# ╔═╡ 5ebbc7ef-ef96-4e1c-8f16-b8251b5f6b24
@userplot CirclePlot

# ╔═╡ b2b45da4-ca97-4de9-a9f8-a2bacbb26188
...
# ╔═╡ 3c3bb5a1-531c-48a1-8b5d-7bb1ceb27551
n = 150

# ╔═╡ b5dbdc50-44d5-4e3c-b11a-634e6b43b22f
t = range(0, 2π, length = n)

# ╔═╡ a131ba64-c0ef-487e-92e0-6637c555dca1
x = sin.(t)

# ╔═╡ 83ed0d28-5a08-4d9c-88b0-c8656f12d16d
y = cos.(t)

# ╔═╡ 400e2d8a-282d-4150-ad8d-e3ead5d541d1
anim = @animate for i ∈ 1:n
    circleplot(x, y, i)
end

# ╔═╡ 7ebdcc7a-b089-4052-bfe0-f1115f049079
